...
export default function ChangePasswordForm() {
  ...
  return (
    <form onSubmit={onSubmit} className="grid gap-3 rounded-2xl border p-4 max-w-md">
      <div>
        ...
        <div className="mt-1 flex items-stretch gap-2">
          ...
          />
          <button type="button" onClick={()=>setShowOld(s=>!s)} className="rounded border px-2 text-xs">
      ...
      <div>
        ...
        <div className="mt-1 flex items-stretch gap-2">
          <input
            ...
            className="w-full rounded border bg-transparent px-3 py-2"
          />
          <button type="button" onClick={()=>setShowNew(s=>!s)} className="rounded border px-2 text-xs">
