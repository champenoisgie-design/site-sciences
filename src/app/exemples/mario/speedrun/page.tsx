...
type Props = {};
const PAGE_TITLE = "Révisions rapides (Mario — Speedrun) — Exemple guidé (mario)";
const steps: string[] = [
  "Étape 1 · 5 questions flash (10 s chacune).",
  "Étape 2 · Bilan : acquis / à revoir.",
  "Étape 3 · Proposition de relance ciblée.",
];
  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-10 space-y-6">
      ...
      <p className="text-muted-foreground">
        Série courte de questions chronométrées (mode speedrun).
      </p>
