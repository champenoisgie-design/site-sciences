...
type Props = {};
const PAGE_TITLE = "Fractions & pièces (Mario) — Exemple guidé (mario)";
const steps: string[] = [
  "Étape 1 · Mario a récupéré 3 pièces sur 5 blocs. Écrire la fraction correspondante (✍️ 3/5).",
  "Étape 2 · Simplifier 6/10 (indice : diviser numérateur et dénominateur par 2 → 3/5).",
  "Étape 3 · Comparer 2/3 et 3/5 (astuce : produit en croix rapide).",
  "Étape 4 · Quizz chronométré : 4 questions simples pour valider.",
];
  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-10 space-y-6">
      ...
      <p className="text-muted-foreground">
        Mini-parcours guidé autour des fractions, façon pièces / blocs.
      </p>
