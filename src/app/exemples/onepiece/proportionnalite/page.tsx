...
type Props = {};
const PAGE_TITLE = "Proportionnalité & ravitaillement (One Piece) — Exemple guidé (onepiece)";
const steps: string[] = [
  "Étape 1 · 4 barils pour 8 marins. Pour 14 marins ? (7 barils si linéaire).",
  "Étape 2 · Compléter les valeurs manquantes.",
  "Étape 3 · Indice : raison et coefficient.",
];
  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-10 space-y-6">
      ...
      <p className="text-muted-foreground">
        Compléter un tableau de ravitaillement pour l’équipage (coefficient multiplicateur).
      </p>
