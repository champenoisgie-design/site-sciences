...
type Props = {};
const PAGE_TITLE = "Électricité — Schémas (One Piece) — Exemple guidé (onepiece)";
const steps: string[] = [
  "Étape 1 · Placer ampoule / générateur / interrupteur.",
  "Étape 2 · Reconnaitre série vs parallèle.",
  "Étape 3 · Bilan acquis / à revoir.",
];
  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-10 space-y-6">
      ...
      <p className="text-muted-foreground">
        Identifier et placer les éléments d’un circuit, puis distinguer série/parallèle.
      </p>
