...
export default function Page() {
  return (
    <article className="prose prose-zinc max-w-none dark:prose-invert">
      ...
      <h2>1. Objet</h2>
      <p>
        Le présent document encadre l’utilisation du site et des services ...
      </p>
      <h2>2. Comptes et accès</h2>
      <ul>
        <li>Un compte est personnel et non cessible.</li>
        <li>
          Une seule connexion simultanée par compte est autorisée (politique
          “single-session”).
        </li>
      ...
      <p>
        Les contenus (textes, exercices, médias) sont protégés. Toute
        reproduction ou rediffusion non autorisée est interdite.
      </p>
      ...
      <ul>
        ...
        <li>
          L’outil ne peut empêcher techniquement la capture d’écran côté
          utilisateur.
        </li>
      </ul>
      <h2>5. Abonnements et facturation</h2>
      <p>
        Les prix, remises “3 matières” et packs famille sont indiqués sur la
